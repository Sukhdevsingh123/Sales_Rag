...
export default function Sidebar() {
  ...
  return (
    <aside className="flex h-full w-[280px] shrink-0 flex-col border-r border-white/5 bg-[#121212]">
      {/* Header */}
      ...
      <div className="mt-5 flex min-h-0 flex-1 flex-col px-3">
        <div className="mb-2 flex items-center justify-between px-1">
          <div className="flex items-center gap-1 text-xs font-semibold uppercase text-gray-400">
        ...
        <div className="relative mt-3">
          ...
          <input
            ...
            className="w-full rounded-lg border border-white/10 bg-white/5 py-2 pl-8 pr-3 text-xs"
          />
        </div>
